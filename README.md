...
### **Key Mechanics**
 ...
 - Transfers items between adjacent rooms without temperature loss.
 - Automatically aligns to the correct wall orientation (horizontal or vertical).
 - Can hold up to 3 item stacks.
 - Found under the Furniture tab (post-research). If using LWM’s Deep Storage, it is categorized under the Storage tab instead.
 - Costs 20 steel, 1 component, and 20 units of material (e.g., wood, stone).
 - Not suitable for chunks, plants, or buildings.
 - Perishable items left in the window will decay over time.



[hr][/hr]
### **Research Progression**
 Unlock the pass-through window after researching Complex Furniture.

[hr][/hr]
### **Compatibility**
 
 - **Game Version:** RimWorld 1.5+.
- **Mod Conflicts:** None known. If it steps on any toes, let us know in the comments!
